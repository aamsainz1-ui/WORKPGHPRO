...
interface SidebarProps {
  activeTab: 'dashboard' | 'history' | 'leave' | 'profile' | 'organization' | 'announcements' | 'admin' | 'summary' | 'calendar' | 'payroll' | 'permissions' | 'teams';
  setActiveTab: (tab: 'dashboard' | 'history' | 'leave' | 'profile' | 'organization' | 'announcements' | 'admin' | 'summary' | 'calendar' | 'payroll' | 'permissions' | 'teams') => void;
  user: UserProfile;
  lang: Language;
